                ...
                <main class="tm-col-right tm-contact-main"> <!-- Content -->
                    <section class="tm-content tm-contact">
								...
								<table>
									<tr>
										...
										<td><input type="text" name="id" id="userId"
											onkeyup="chkId()" placeholder="아이디 입력"> <input
											type="button" onclick="chkDup()" value="아이디 중복확인"><br>
										</td>
										<td><span id="chkDupId"></span></td>
									</tr>
									<tr>
										<td></td>
									...
									<tr>
										...
										<td><input type="text" name="email" id="email"
											placeholder="이메일 주소 입력"> <input type="button"
									...
									<tr id="hidden" style="display: none;">
										...
										<td><input type="text" id="code"
											placeholder="인증코드를 입력해주세요"> <input type="button"
							...
							<input type="button" onclick="chk_form()" value="회원가입"
								class="btn btn-big btn-primary"> <input type="button"
